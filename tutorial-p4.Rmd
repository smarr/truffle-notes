...
on the same principles that we discussed before, this post will be much shorter
and only sketch the changes to existing elements. However, we discuss in greater
detail how to add local variables, a for-loop, and how to call Java functions
...
- added cast nodes: intValue, doubleValue
- added support for `not` operator

- introduce local variables
  - assignment

- for loops, incl. break
